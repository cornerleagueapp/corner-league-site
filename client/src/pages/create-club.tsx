    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="relative text-center mb-8">
          ...
          <p className="text-gray-400">Set up your sports club for fans to join</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Choose how many people can join your club</p>
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => handleInputChange("streamingSource", e.target.value)}
              className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
            ...
            <div className="text-sm text-gray-400 mt-2">
              {formData.streamingSource === "nfl" && "Stream live NFL content and highlights"}
              {formData.streamingSource === "youtube" && "Stream live TV and sports on Fubo TV"}
            </div>
          </div>

          {/* Buy Me a Coffee */}
          <div>
            <label htmlFor="buyMeCoffeeUsername" className="block text-sm font-medium text-gray-300 mb-2">
              Tip (Optional)
            </label>
            <input
              type="text"
              ...
              className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <p className="text-xs text-gray-500 mt-1">Members can tip. Just go to <a href="https://buymeacoffee.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline">buymeacoffee.com</a>, create an account, and input your url.</p>
          </div>

          {/* Form Summary */}
          <div className="bg-gray-800 border border-gray-600 rounded-md p-4">
            <h3 className="text-sm font-medium text-gray-300 mb-2">Club Summary</h3>
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-400">Name:</span>
                <span className="text-white">{formData.clubName || "Not set"}</span>
              </div>
              {formData.description && (
                <div className="flex justify-between">
                  <span className="text-gray-400">Description:</span>
                  <span className="text-white text-right max-w-xs truncate">{formData.description}</span>
                </div>
              )}
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className={`${formData.isPrivate ? 'text-orange-400' : 'text-green-400'}`}>
              ...
              <div className="flex justify-between">
                ...
                <span className="text-blue-400">
                  {formData.streamingSource === "nfl" ? "NFL Network" : "Fubo TV"}
                </span>
              </div>
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={!formData.clubName.trim() || createClubMutation.isPending}
