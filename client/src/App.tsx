...
import PollsDetailsPage from "@/pages/polls/pollsDetailsPage";
import AdminPollsPage from "@/pages/admin/admin-polls-page";
import RacePodPage from "./pages/profile/racepod";
import RacePodSessionPage from "@/pages/racePods/racepod-session";
    ...
    <AppShell>
      <ErrorBoundary>
        <Switch>
          ...
          <Route path="/organizations/:organizationId/admin/events/:eventId/classes/:divisionId/manage">
            {(params) => (
              <ClassMatchManagePage
